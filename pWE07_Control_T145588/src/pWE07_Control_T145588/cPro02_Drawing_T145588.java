 ...
 *
 */
public class cPro02_Drawing_T145588 extends JFrame {
	cPro02_Drawing_T145588_Panel abc = new cPro02_Drawing_T145588_Panel();
	...
	public static void main(String[] args) {
		...
		cPro02_Drawing_T145588 wMain = new cPro02_Drawing_T145588();
		wMain.setDefaultCloseOperation(EXIT_ON_CLOSE);
		wMain.setVisible(true);
	}

	
	public cPro02_Drawing_T145588() {
        final ArrayList toado = new ArrayList(); // Khai báo 1 đối tượng ArrayList
		...
		ve.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				String num1 = x1.getText();
				toado.add(num1);
				String num2 = y1.getText();
				toado.add(num2);
				String num3 = x2.getText();
				toado.add(num3);
				String num4 = y2.getText();
				toado.add(num4);

				if (arg0.getSource()== ve){
